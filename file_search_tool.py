...
def cleanup_file_search_function(file_search_func):
    ...
    """
    if hasattr(file_search_func, '_vector_store_id') and hasattr(file_search_func, '_client'):
        try:
            file_search_func._client.vector_stores.delete(file_search_func._vector_store_id)
        except Exception as e:
